...
class SBDueScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SBDueScreen> createState() => _SBDueScreenState();
}

class _SBDueScreenState extends ConsumerState<SBDueScreen> {
  ...
  final List<Map<String, dynamic>> _columns = [
    ...
    {'label': 'Amount', 'key': 'amount', 'width': 100.0},
    {'label': 'Due Date', 'key': 'duedate', 'width': 110.0},
  ];

  @override
  void initState() {
    super.initState();
    _dataFuture = ref.read(lifePlusProvider.notifier).getSBDueData(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('SB Dues'),
        backgroundColor: const Color(0xFFF59E0B), // Amber color for SB Dues
        elevation: 0,
