...
class WeddingReportScreen extends ConsumerStatefulWidget {
  final DateTime? fromDate;
  final DateTime? toDate;
  final String? agency;

  const WeddingReportScreen({
    super.key, 
    this.fromDate, 
    this.toDate,
    this.agency,
  ...
  @override
  ConsumerState<WeddingReportScreen> createState() => _WeddingReportScreenState();
}

class _WeddingReportScreenState extends ConsumerState<WeddingReportScreen> {
  ...
  final List<Map<String, dynamic>> _columns = [
    ...
    {'label': 'Wedding Date', 'key': 'wdt', 'width': 120.0},
  ...
  void initState() {
    super.initState();
    _dataFuture = ref.read(lifePlusProvider.notifier).getWeddingData(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wedding Day Report'),
        backgroundColor: const Color(0xFFF43F5E), // Rose color
        elevation: 0,
